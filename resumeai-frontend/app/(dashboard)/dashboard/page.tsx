...
export default function DashboardPage() {
    ...
    return (
        <div className="p-8 space-y-8 max-w-5xl">
            ...
            {/* Quick actions + Top language */}
            <div className="grid md:grid-cols-3 gap-4">
                <Link href="/generate" className="group col-span-1 bg-white/[0.03] border border-white/8 hover:border-violet-500/30 rounded-2xl p-5 flex items-center gap-4 transition-all duration-200">
                ...
                <Link href="/history" className="group col-span-1 bg-white/[0.03] border border-white/8 hover:border-violet-500/30 rounded-2xl p-5 flex items-center gap-4 transition-all duration-200">
                    <div className="w-10 h-10 bg-violet-500/10 border border-violet-500/20 rounded-xl flex items-center justify-center text-violet-400 text-lg group-hover:bg-violet-500/20 transition-colors">◷</div>
                    <div>
                ...
                <Link href="/study" className="group col-span-1 bg-white/[0.03] border border-white/8 hover:border-emerald-500/30 rounded-2xl p-5 flex items-center gap-4 transition-all duration-200">
